...
With few exceptions, a table of wavelengths and values is interpreted as _step function_.
...
In `plot()` the spectra are plotted as piecewise-linear using `lines()`,
though plotting option for step functions might be added in the future.
