...
```{r, echo=TRUE, message=TRUE, fig.width=7, fig.height=5,  fig.show='hold'}
...
The background graylevel `bg` is slightly less than 255 so that the
red channel in the colors is not saturated.
If the background were 'peak white' (255,255,255),
then some of the colors would be outside the sRGB gamut.
